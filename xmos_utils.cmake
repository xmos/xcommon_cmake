...
function(XMOS_REGISTER_APP)
    ...
    foreach(target ${XMOS_TARGETS_LIST})
        ...
        list(APPEND DEPS_TO_LINK ${CMAKE_ARCHIVE_OUTPUT_DIRECTORY}/${prefix}${target}.a)
    endforeach()
...
function(XMOS_REGISTER_MODULE)
    ...
    if(NOT TARGET ${LIB_NAME})
        if(NOT ${LIB_NAME}_SILENT_FLAG)
            ...
            # If library name starts with "lib_", remove the "lib" prefix from the build product
            if(${LIB_NAME} MATCHES "^lib_.*")
