...
function(XMOS_REGISTER_APP)
    ...
    foreach(APP_CONFIG ${APP_CONFIGS})
        ...
        if(${APP_CONFIG} STREQUAL "DEFAULT")
            ...
            target_compile_options(${PROJECT_NAME} PRIVATE ${APP_COMPILER_FLAGS})
            target_link_options(${PROJECT_NAME} PRIVATE ${APP_COMPILER_FLAGS})
            ...
            target_compile_options(${PROJECT_NAME}_${APP_CONFIG} PRIVATE ${APP_COMPILER_FLAGS_${APP_CONFIG}} "-DCONFIG=${APP_CONFIG}")
            target_link_options(${PROJECT_NAME}_${APP_CONFIG} PRIVATE ${APP_COMPILER_FLAGS_${APP_CONFIG}} "-DCONFIG=${APP_CONFIG}")
            list(APPEND BUILD_TARGETS ${PROJECT_NAME}_${APP_CONFIG})
        endif()
    endforeach()

    # Add generic options for all app targets
    foreach(target ${BUILD_TARGETS})
        target_include_directories(${target} PRIVATE ${APP_INCLUDES})
        target_compile_options(${target} PRIVATE ${APP_TARGET_COMPILER_FLAG})
        target_link_options(${target} PRIVATE ${APP_TARGET_COMPILER_FLAG})
    endforeach()
